...
- It can't (yet) recreate original _transient markers._ (-Hopefully this can be implemented soon.)
- It can't (yet) recreate any 'RegionFX'/'Region Effects', which is [a brand-new feature](https://manual.ardour.org/mixing/automation/applying-effects-to-regions-separately/) in Ardour 9.
...
Simply [click here to download the AudioClipboard.lua (v1.1) file](https://github.com/GhostsonAcid/AudioClipboard/releases/download/v1.1/AudioClipboard.lua), and then do the following based on your OS:
